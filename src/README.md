...
* User will ask login creadential then a thread will check login credential
   * if creadential matches then the _backgrond thread_ will generate random transaction amount.
   * On every 100/- spent, you will get 1 point as reward and user can reddem these points to purchase various items in available categories.
